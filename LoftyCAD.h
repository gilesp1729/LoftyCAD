...
// Version
#define LOFTYCAD_VERSION "1.6"
#define LOFTYCAD_BRANCH "(Double Helix)"
...
extern double effective_angle;
extern double eff_sx;
extern double eff_sy;
extern double eff_sz;
extern double halo_rad;
extern BOOL suppress_drawing;
extern double bed_xmin;
extern double bed_ymin;
extern double bed_xmax;
extern double bed_ymax;
extern double layer_height;
extern double print_zmin;
extern double print_zmax;
extern Plane clip_plane;
extern BOOL view_clipped;
extern BOOL draw_on_clip_plane;

extern char curr_filename[];
extern double grid_snap;
extern double tolerance;
extern double snap_tol;
extern int tol_log;
extern int angle_snap;
extern BOOL snapping_to_grid;
extern BOOL snapping_to_angle;
extern double chamfer_rad;
extern double round_rad;
extern double half_size;
extern double default_stepsize;
extern double clip_xoffset, clip_yoffset, clip_zoffset;
...
void spaghetti(ZPolyEdge * zedge, double zmin, double zmax);
...
void insert_chamfer_round(Point * pt, Face * parent, double size, EDGE edge_type, BOOL restricted);
...
double path_total_length(Object * obj);
